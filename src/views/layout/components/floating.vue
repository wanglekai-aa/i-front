<template>
  <div class="fixed bottom-10 right-2">
    <!-- 引导页 -->
    <div
      class="guide-start w-4 h-4 mb-1 bg-white dark:bg-zinc-900 border dark:border-0 border-zinc-200 rounded-full flex items-center justify-center cursor-pointer duration-200 group hover:shadow-lg"
    >
      <m-svg-icon
        name="guide"
        class="w-2 h-2"
    ...
    <m-popover class="flex items-center guide-feedback" placement="left-top">
      ...
      <div class="w-[140px] overflow-hidden">
        <div
          class="flex items-center p-1 cursor-pointer rounded hover:bg-zinc-100/60 dark:hover:bg-zinc-100"
        >
          <m-svg-icon
            name="feedback"
